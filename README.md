...
2. Install [vcpkg](https://learn.microsoft.com/en-gb/vcpkg/get_started/get-started-vscode?pivots=shell-powershell) and set the `VCPKG_ROOT` environment variable to your vcpkg installation directory.
